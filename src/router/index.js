...
export const constantRouterMap = [
  ...
  
  {
    ...
    children: [
      { 
        path: 'create', 
        component: () => import('@/views/vocabulary/create'), 
        name: 'Create Vocabulary', 
        meta: { title: '创建词汇表', icon: 'edit' }
      },
      { 
        path: 'list', 
        component: () => import('@/views/vocabulary/list'), 
        name: 'Vocabulary List', 
        meta: { title: '词汇表', icon: 'list' }
      },  
      { 
        path: 'edit/:id(\\d+)', 
        component: () => import('@/views/vocabulary/edit'), 
...

  {
    ...
    children: [
      ...
      { 
        ...
        name: 'Create banner', 
        meta: { title: 'Create banner', icon: 'tree' }
      },
      { 
        path: 'edit/:id(\\d+)', 
    ...
    children: [
      {
        path: 'userinfo',
        name: 'User info',
        component: () => import('@/views/settings/userinfo'),
